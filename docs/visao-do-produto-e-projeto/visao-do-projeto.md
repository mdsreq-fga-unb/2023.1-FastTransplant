...
## Planejamento das Fases e/ou Iterações

Fase 1: Definição de requisitos (elicitação e descoberta, análise e consenso, etc.) (02/05 - 09/05)
...
A tabela 2 traz um resumo de cada fase e quais serão os produtos de gerados de cada fase
...
| Fase 6   | Finalização do MVP2, validação e testes        | MVP2 desenvolvido e validado                  | 05/07/23        | 17/07/23     |
...
Tabela 3 - Matriz de Comunicação (Fonte: Autor, 2023)
